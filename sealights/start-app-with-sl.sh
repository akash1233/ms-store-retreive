...
java -javaagent:$SL_FOLDER/sl-test-listener.jar -Dsl.webappLocation="../target" -Dsl.featuresData.enableHttpColoring=true -Dsl.log.toFile=true -Dsl.log.level=info -Dserver.port=8080 -jar ../target/store-retreive-0.0.1-SNAPSHOT.war
